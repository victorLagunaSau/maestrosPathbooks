...
export default function Home() {
	...
	const botonesOtrosGrados = [
		{id: "izquierdo", text: "< Secundaria 3", url: "/secundaria3"},
	...
	const meses = [
			...
			lecturas: [
				{
					...
					lecturaId: "LpQ1NqM0n6XsA85XTaMQ",
					title: "Semana 3",
			...
			lecturas: [
				{
					...
					lecturaId: "4ZaaZx7ZwFLLAMPZdm8G",
					title: "Semana 3",
					error: "Próximamente: Metamorfosis",
					activityMateriales: null,
				}
			],
			checked: false
		...
		},
		{
			...
			lecturas: [
				{
					lecturaId: "G70wc6ADKi7DuJRTS7b8",
					title: "Semana 1",
					error: "Próximamente: A la deriva",
					activityMateriales: null,
				}, {
			...
			lecturas: [
				{
					...
					title: "Semana 1",
					error: "Próximamente: Nos cubre el Sauce",
					activityMateriales: null,
				}, {
