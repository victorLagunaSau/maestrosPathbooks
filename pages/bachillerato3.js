...
export default function Home() {
	...
	const botonesOtrosGrados = [
		{id: "izquierdo", text: "< Bachillerato 1", url: "/bachillerato1"},
		{id: "centro", text: "Otros grados", url: "/"},
		{id: "derecho", text: "Bachillerato 2 >", url: "/bachillerato2"},
	];
	...
	const meses = [
			...
			lecturas: [
				{
					...
					title: "Semana 3",
					error: "Próximamente: Vestigios del mañana",
					activityMateriales: null,
				}
			],
			checked: false
		...
		},
		{
			...
			lecturas: [
				{
					lecturaId: "a1qeqEv1mlYD0O701huo",
					title: "Semana 1",
					error: "Próximamente: El escarmiento de Fernando",
					activityMateriales: null,
				}, {
		...
		},
		{
			...
			lecturas: [
				{
					lecturaId: "Hq0jIrGMyThWgGoyl8Kf",
					title: "Semana 1",
					error: "Próximamente: Día de muertos en el campo",
					activityMateriales: null,
				}, {
		...
		},
		{
			...
			lecturas: [
				{
					lecturaId: "pnxe9X3lLvQV1lfI7fQG",
					title: "Semana 1",
					error: "Próximamente: El secreto de Miranda",
					activityMateriales: null,
				}, {
	...
	return (
		<>
			<LayoutGrados>
				<SeoHead title="Bachillerato 3"/>
				<ModuloInicio grado="Bachillerato 3"/>
				<ModuloOtrosGrados botonesOtrosGrados={botonesOtrosGrados}/>
				<ModuloPlanLector grado="Bachillerato 3" botonesPlanLector={botonesPlanLector} imagen="/assets/planlectorP1.png" hrefVideo="https://www.youtube.com/watch?v=SVDATXnwXEw" textVideo="Ir a Video Explicativo"/>
				<ModuloObjetivos/>
				<ModuloMetodologia/>
				<MEI/>
