...
export default function Home() {
	...
	const botonesOtrosGrados = [
		...
		{id: "derecho", text: "Bachillerato 3 >", url: "/bachillerato3"},
	];
			...
			lecturas: [
				{
					...
					title: "Semana 3",
					error: "Próximamente: Veinte Mil Leguas de Viaje Submarino",
					activityMateriales: null,
				}
			],
			checked: false
	...
	return (
		<>
			<LayoutGrados>
				<SeoHead title="Bachillerato 2"/>
				<ModuloInicio grado="Bachillerato 2"/>
				<ModuloOtrosGrados botonesOtrosGrados={botonesOtrosGrados}/>
				<ModuloPlanLector grado="Bachillerato 2" botonesPlanLector={botonesPlanLector} imagen="/assets/planlectorP1.png" hrefVideo="https://www.youtube.com/watch?v=SVDATXnwXEw" textVideo="Ir a Video Explicativo"/>
				<ModuloObjetivos/>
				<ModuloMetodologia/>
				<MEI/>
